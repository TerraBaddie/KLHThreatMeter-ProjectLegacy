...
me.specialattack = function(abilityid, target, damage, iscrit, spellschool)
	...
	if mod.my.class == "paladin" then
		...
		-- Project Legacy/Vanilla rule: Righteous Fury affects Holy attacks only.
	...
	elseif mod.my.class == "shaman" then
		if mod.data.isprojectlegacyshock(abilityid, nil) then
			me.event.threat = me.event.threat * mod.my.mods.shaman.shockthreat
		end
...
me.normalattack = function(spellname, spellid, damage, isdot, target, iscrit, spellschool)
	...
	-- Shaman
	elseif mod.my.class == "shaman" then
		if mod.data.isprojectlegacyshock(spellid, spellname) then
			me.event.threat = me.event.threat * mod.my.mods.shaman.shockthreat
		end
